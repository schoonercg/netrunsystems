...
def test_netrunmail_integration():
    ...
    print("-" * 40)
    print("1. Deploy application with Netrunmail service principal configuration")
    print("2. Set environment variables:")
    print("   - AZURE_COMMUNICATION_SERVICE_ENDPOINT=https://netrunmail.communication.azure.com")
    print("   - AZURE_EMAIL_SENDER=noreply@netrunmail.com")
    print("   - AZURE_CLIENT_ID=<service-principal-id> (existing)")
    print("   - AZURE_CLIENT_SECRET=<service-principal-secret> (existing)")
    print("   - AZURE_TENANT_ID=<tenant-id> (existing)")
    print("3. Assign Azure Communication Services permissions to service principal")
    ...
    print("-" * 40)
    print("SUCCESS:")
    print("- 'Netrunmail service configured with sender: noreply@netrunmail.com'")
    print("- 'Sending email via Netrunmail service principal from noreply@netrunmail.com'") 
    print("- '✅ Netrunmail email sent successfully to [email]. Message ID: [id]'")
    print()
    print("FAILURES:")
    print("- 'Netrunmail Azure Communication Email or Identity not available'")
    print("- 'Netrunmail service endpoint not configured'")
    print("- 'Service principal credentials not configured for Netrunmail'")
    ...
    print("3. Ensure service principal has Communication Services permissions")
    print("4. Check sender email domain verification")
    print("5. Verify service principal credentials (CLIENT_ID, CLIENT_SECRET, TENANT_ID)")
    print("6. Review Azure Communication Services quotas")
    print("7. Check DefaultAzureCredential authentication flow")
    print()
